...
bool usingScreenLayer = true;
bool resetScreenLayerRenderer = false;
...
void TBXR_InitialiseOpenXR()
{
	...
	strcpy(appInfo.applicationName, "BeefRaiderXR");
	appInfo.applicationVersion = 0;
	strcpy(appInfo.engineName, "BeefRaiderXR");
...
void TBXR_submitFrame()
{
	...
	else
	{
		...
		usingScreenLayer = true;
		if (resetScreenLayerRenderer) {
			resetScreenLayerRenderer = false;
			VR_ResetRenderer();
		}
